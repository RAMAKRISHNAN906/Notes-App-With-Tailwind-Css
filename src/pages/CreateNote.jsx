...
import { useCreateDate } from '../components/useCreateDate/useCreateDate';
    ...
    return (
        <section className='w-full min-h-screen h-auto flex flex-col items-center'>
            <header className='create-note-header w-full flex items-center justify-between p-5'>
                ...
                <button onClick={handleSubmit} className="text-white text-lg bg-purple-600 py-2 px-4 rounded-md">Save</button>
            </header>
